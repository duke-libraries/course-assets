class BatchController < ApplicationController
  ...
  def edit
    ...
    @generic_file.creator = [creator_user.inverted_name]
  ...
  def update
    ...
    flash[:notice] = 'Your files are being processed by ' + t('sufia.product_name') + ' in the background. The metadata and access controls you specified are being applied. Files will be marked <span class="label label-important" title="Restricted">Restricted</span> until this process is complete (shouldn\'t take too long, hang in there!). You may need to refresh your dashboard to see these updates.'
  ...
  def creator_user
    gf = @batch.generic_files.first
    user_key = gf.on_behalf_of.present? ? gf.on_behalf_of : gf.depositor
